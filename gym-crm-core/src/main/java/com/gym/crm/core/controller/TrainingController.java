...
import static com.gym.crm.core.controller.ApiConstants.ROOT_PATH;
...
public class TrainingController {
    ...
    public ResponseEntity<Void> addTraining(@RequestBody TrainingCreateRequest trainingCreateRequest) {
